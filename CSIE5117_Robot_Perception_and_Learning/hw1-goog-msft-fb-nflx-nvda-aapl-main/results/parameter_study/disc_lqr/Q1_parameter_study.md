# Q1. Parameter Sensitivity Study - DISC_LQR

## Overview

This study investigates the effects of adjusting Q matrix (state cost), R value (control cost), and max_steps on the performance of the DISC_LQR controller.
...
|------------|----------|---------|-------|---------------|------------------|-------------|
| Baseline (balanced) | [0.2, 0.2, 2.0, 0.5] | ✅ | 1000 | 2.685 | 1.419 | 0.813 |
| High position weight | [2.0, 0.2, 2.0, 0.5] | ✅ | 1000 | 2.685 | 0.458 | 0.745 |
| High angle weight | [0.2, 0.2, 10.0, 0.5] | ✅ | 1000 | 2.685 | 1.419 | 0.813 |
| All equal weights | [1.0, 1.0, 1.0, 1.0] | ✅ | 1000 | 2.685 | 0.580 | 0.752 |
| Angle-focused | [0.1, 0.1, 5.0, 1.0] | ✅ | 1000 | 2.685 | 2.101 | 0.820 |
...
|------------|---------|---------|-------|---------------|------------------|-------------|
| Low R (aggressive) | 0.50 | ✅ | 1000 | 2.685 | 0.783 | 0.778 |
| Baseline R | 1.50 | ✅ | 1000 | 2.685 | 1.419 | 0.813 |
| High R (conservative) | 5.00 | ❌ | 776 | 2.685 | 2.402 | 0.782 |
| Very high R | 10.00 | ❌ | 720 | 2.685 | 2.403 | 0.714 |
...
|------------|-----------|---------|-----------------|-----------------|-------------------|
| Short episode (200) | 200 | ✅ | 200 | 0.028 | 0.649 |
| Medium episode (500) | 500 | ✅ | 500 | 0.368 | 1.405 |
| Standard episode (1000) | 1000 | ✅ | 1000 | 0.336 | 1.118 |
| Long episode (2000) | 2000 | ✅ | 2000 | 0.186 | 0.793 |
