...
def sample(
    ...
    **model_kwargs,
    ...
    # initialize cache_position if not present (needed for newer transformers)
    ...
    while True:
        ...
        if use_cd:
            # sync cache_position from main kwargs to cd kwargs
            if "cache_position" in model_kwargs:
                model_kwargs_cd["cache_position"] = model_kwargs["cache_position"]
