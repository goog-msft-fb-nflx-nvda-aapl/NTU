# Q1. Parameter Sensitivity Study - CONT_LQR

## Overview

This study investigates the effects of adjusting Q matrix (state cost), R value (control cost), and max_steps on the performance of the CONT_LQR controller.
