# Q1. Parameter Sensitivity Study - ILQR

## Overview

This study investigates the effects of adjusting Q matrix (state cost), R value (control cost), and max_steps on the performance of the ILQR controller.
...
|------------|----------|---------|-------|---------------|------------------|-------------|
| Baseline (balanced) | [0.2, 0.2, 2.0, 0.5] | ✅ | 1000 | 2.685 | 1.158 | 0.812 |
| High position weight | [2.0, 0.2, 2.0, 0.5] | ✅ | 1000 | 2.685 | 0.294 | 0.801 |
| High angle weight | [0.2, 0.2, 10.0, 0.5] | ✅ | 1000 | 4.486 | 1.304 | 0.787 |
| All equal weights | [1.0, 1.0, 1.0, 1.0] | ✅ | 1000 | 2.685 | 0.375 | 0.560 |
| Angle-focused | [0.1, 0.1, 5.0, 1.0] | ✅ | 1000 | 3.679 | 1.507 | 0.694 |
...
|------------|---------|---------|-------|---------------|------------------|-------------|
| Low R (aggressive) | 0.50 | ✅ | 1000 | 3.772 | 0.840 | 0.616 |
| Baseline R | 1.50 | ✅ | 1000 | 2.685 | 1.158 | 0.812 |
| High R (conservative) | 5.00 | ❌ | 625 | 2.685 | 2.406 | 0.770 |
| Very high R | 10.00 | ❌ | 600 | 2.685 | 2.400 | 0.620 |
...
|------------|-----------|---------|-----------------|-----------------|-------------------|
| Short episode (200) | 200 | ✅ | 200 | 0.625 | 0.715 |
| Medium episode (500) | 500 | ✅ | 500 | 0.129 | 1.055 |
| Standard episode (1000) | 1000 | ✅ | 1000 | 0.046 | 1.118 |
| Long episode (2000) | 2000 | ✅ | 2000 | 1.323 | 1.645 |
